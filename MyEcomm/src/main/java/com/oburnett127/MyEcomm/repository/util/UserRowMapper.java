...
public class UserRowMapper implements RowMapper<User> {
	...
	public User mapRow(ResultSet rs, int rowNum) throws SQLException {
		User user = new User(1, "fakeemail@fakeemail.com", "Bob", "Jones", "abc123", false, new Cart(1, 0, new BigDecimal(0.00), new ArrayList<Product>( ) ));
